...
<table id='font-awesome-demo'>
  <tbody>
    ...
    <tr>
      ...
      <td class="icon-cell" data-icon="window-restore">
        <span></span>
        <br/>fa-window-restore
      </td>
      <td class="icon-cell" data-icon="times-rectangle">
        <span></span>
        <br/>fa-times-rectangle
      </td>
    </tr>
    <tr>
      <td class="icon-cell" data-icon="window-close">
        <span></span>
        <br/>fa-window-close
      </td>
      <td class="icon-cell" data-icon="times-rectangle-o">
        <span></span>
        <br/>fa-times-rectangle-o
      </td>
      <td class="icon-cell" data-icon="window-close-o">
        <span></span>
        <br/>fa-window-close-o
      </td>
      <td class="icon-cell" data-icon="bandcamp">
        <span></span>
        <br/>fa-bandcamp
      </td>
    </tr>
    <tr>
      <td class="icon-cell" data-icon="grav">
        <span></span>
        <br/>fa-grav
      </td>
      <td class="icon-cell" data-icon="etsy">
        <span></span>
        <br/>fa-etsy
      </td>
      <td class="icon-cell" data-icon="imdb">
        <span></span>
        <br/>fa-imdb
      </td>
      <td class="icon-cell" data-icon="ravelry">
        <span></span>
        <br/>fa-ravelry
      </td>
    </tr>
    <tr>
      <td class="icon-cell" data-icon="eercast">
        <span></span>
        <br/>fa-eercast
      </td>
      <td class="icon-cell" data-icon="microchip">
        <span></span>
        <br/>fa-microchip
      </td>
      <td class="icon-cell" data-icon="snowflake-o">
        <span></span>
        <br/>fa-snowflake-o
      </td>
      <td class="icon-cell" data-icon="superpowers">
        <span></span>
        <br/>fa-superpowers
      </td>
    </tr>
    <tr>
      <td class="icon-cell" data-icon="wpexplorer">
        <span></span>
        <br/>fa-wpexplorer
      </td>
      <td class="icon-cell" data-icon="meetup">
        <span></span>
        <br/>fa-meetup
      </td>
    </tr>
